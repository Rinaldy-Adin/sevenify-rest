...
export default function (app: Router) {
    app.get("/admin/pending", authenticateToken(true, 'admin'), getPendingUsersController);
    app.post("/admin/pending/:user_id", authenticateToken(true, 'admin'), validatePendingAction, postPendingActionController);
}